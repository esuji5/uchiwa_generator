...
function App() {
  const {
    ...
    downloadMethod,
    setDownloadMethod, // downloadMethod は UI 次第で削除検討
    addDeco,
    handleDecoMouseDown,
    clearDecos,
    addRandomDecos,
  ...
  React.useEffect(() => {
    ...
    const checkFontAvailability = () => {
      ...
      const fontTests = [
        ...
        {
          name: 'ヒラギノ丸ゴ',
          family: '"ヒラギノ丸ゴ Pro W4", "Hiragino Maru Gothic Pro", sans-serif',
        },
      ];
        ...
        Promise.allSettled([
          ...
          .then((results) => {
            ...
            if (isAvailable) {
              ...
              console.warn(
                'フォント読み込みの最大試行回数に達しました、フォールバックを使用します'
              );
  ...
  return (
    <div className="app-container" style={{ fontFamily }}>
      ...
      <div className="container">
        ...
        <div
          className="footer"
          style={{ textAlign: 'center', marginTop: 24, fontSize: 14, color: '#666' }}
        >
          © 2025 推し活うちわジェネレーター - 好きな推しのうちわを簡単デザイン！
          <br />
          <a
