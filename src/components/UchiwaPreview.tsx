...
import type { DecoItem, TextItem } from '../types';
...
export const UchiwaPreview: React.FC<UchiwaPreviewProps> = ({
  ...
  return (
    <div className="preview-container">
            ...
            <>
              <defs>
                <clipPath id="rounded-corners">
                  <rect x="0" y="0" width="360" height="360" rx="40" ry="40" />
                </clipPath>
              </defs>
              <rect
                x="0"
          ...
          {decos.map((deco, i) => (
            <g key={deco.id}>
              ...
              {!isDownloading && (
                ...
                >
                  <circle
                    cx={deco.x + deco.size / 2 - 8}
                    cy={deco.y - deco.size / 2 + 8}
                    r="10"
                    fill="#fff"
                    stroke="#888"
                    strokeWidth="1"
      ...
      {/* サンプル画像セクション */}
      <div
        className="sample-images-section"
        style={{
          marginTop: '20px',
          padding: '15px',
